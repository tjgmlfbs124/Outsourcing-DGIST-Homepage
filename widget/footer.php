    ...
    <div class="container">
        <div class="row mtn-40" style="background:#f8f9fc;">
            ...
            <div class="col-lg-4" style="font-size:12px; text-align:center;">
              <div class="copyright-txt">
                <p style="margin:0; color:#333;">(우)42988 대구광역시 달성군 현풍읍 테크노중앙대로 333, R4 205호</p>
                <p style="margin:0; color:#333;">COPYRIGHT(C) DGIST. ALL RIGHTS RESERVED.</p>
              </div>
            </div>
            ...
            <div class="col-lg-3" style="font-size:12px; text-align:center;" >
              <div class="copyright-txt">
                  <a style="color:#333; float:left; line-height:40px;">관련 학부</a>
