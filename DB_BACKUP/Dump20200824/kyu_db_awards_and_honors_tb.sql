...
CREATE TABLE `awards_and_honors_tb` (
  ...
  CONSTRAINT `awards_and_honors_tb_ibfk_1` FOREIGN KEY (`professorid`) REFERENCES `professor_tb` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `awards_and_honors_tb` VALUES (2,'Award of minister of Trade, Industry & Energy in Korea (2015), Tech-Biz. Top 3',2),(3,'Award of minister of Science, ICT and Planning in Korea (2013), Outstanding performance',2),(4,'Man of DGIST of the year(2012)',2),(5,'Great minds of the 21st Century (ABI, 2012, 2013)',2),(6,'2000 outstanding intellectuals of the 21st Century (IBC, 2011)',2),(7,'Honor of Best researcher in DGIST(2007)',2),(8,'Best paper award in COOC(1999)',2),(9,'Nov./19, 임베디드공학회 우수논문상',7),(10,'Mar./14, 교육과학기술부 장관상',7),(11,'Sep./10, 대구경북과학기술원 공로상',7);
