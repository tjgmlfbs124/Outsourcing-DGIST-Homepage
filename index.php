                ...
                <ul>
                    ...
                    <li data-index="rs-27" data-transition="random-premium" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                        ...
                        <div class="tp-caption Button-Outline-Secondary rev-btn" id="slide-27-layer-11" data-x="['left','left','left','left']" data-hoffset="['135','135','45','40']"
                            ...
                            data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[40,40,40,30]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[40,40,40,30]">Learn More
                        </div>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5 m-auto text-center">
                        <div class="section-title section-title--light">
                            <h6>대구경북과학기술원 미래장치융합부</h6>
                            <h2 class="mb-0">ABCDEFG, HIJKLMNOPQRSTUVWXYZ</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row mtn-30">
                        ...
                        <div class="service-item">
                            ...
                            <div class="service-content">
                                <div class="service-content-inner">
                                    <h5><a href="service-details.html" class="stretched-link"></a>학과소개</h5>
                                    <p>ABCDEFG, HIJKLMNOPQRSTUVWXYZ ABCDEFG, HIJKLMNOPQRSTUVWXYZ ABCDEFG, HIJKLMNOPQRSTUVWXYZ</p>
                                </div>
                            </div>
                        </div>
                        <!-- End Service Item -->
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="service-item">
                            ...
                            <div class="service-content">
                                <div class="service-content-inner">
                                    <h5><a href="service-details.html" class="stretched-link">입학안내</a></h5>
                                    <p>ABCDEFG, HIJKLMNOPQRSTUVWXYZ ABCDEFG, HIJKLMNOPQRSTUVWXYZ ABCDEFG, HIJKLMNOPQRSTUVWXYZ</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="service-item">
                            ...
                            <div class="service-content">
                                <div class="service-content-inner">
                                    <h5><a href="service-details.html" class="stretched-link">연구분야</a></h5>
                                    <p>ABCDEFG, HIJKLMNOPQRSTUVWXYZ ABCDEFG, HIJKLMNOPQRSTUVWXYZ ABCDEFG, HIJKLMNOPQRSTUVWXYZ</p>
                                </div>
                            </div>
                            <!-- End Service Item -->
