                                  ...
                                  <div class="col-sm-6 col-lg-3">
                                      <div class="team-mem-item">
                                          ...
                                          <div class="member-info">
                                              <h5><a href="team-details.html" class="stretched-link">Hond Gil Dong</a></h5><br>
                                              <span class="designation" style="float:left;">Position : student</span><br>
                                              <span class="designation" style="float:left;">Phone : 010-4517-6040</span><br>
                                              <span class="designation" style="float:left;">Email : abcdef@dgist.ac.kr</span><br>
                                          </div>
                                      </div>
                                  </div>
