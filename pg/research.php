                      ...
                      <div class="blog-content-wrapper">
                          <div class="row mtn-30">
                              <div class="col-md-6 col-lg-4">
                                  <div class="blog-item">
                                      <figure class="blog-thumb">
                                          <a href="blog-details.html"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/assets/img/service/01.jpg" alt="Businex-Blog" /></a>
                                      </figure>
                                  </div>
                              </div>
                              ...
                              <div class="col-md-6 col-lg-4">
                                  <div class="blog-item">
                                      <figure class="blog-thumb">
                                          <a href="blog-details.html"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/assets/img/service/02.jpg" alt="Businex-Blog" /></a>
                                      </figure>
                                  </div>
                              </div>
                              ...
                              <div class="col-md-6 col-lg-4">
                                  <div class="blog-item">
                                      <figure class="blog-thumb">
                                          <a href="blog-details.html"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/assets/img/service/03.jpg" alt="Businex-Blog" /></a>
                                      </figure>
                                  </div>
                              </div>
                              ...
                              <div class="col-md-6 col-lg-4">
                                  <div class="blog-item">
                                      <figure class="blog-thumb">
                                          <a href="blog-details.html"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/assets/img/service/04.jpg" alt="Businex-Blog" /></a>
                                      </figure>
                                  </div>
                              </div>
                              ...
                              <div class="col-md-6 col-lg-4">
                                  <div class="blog-item">
                                      <figure class="blog-thumb">
                                          <a href="blog-details.html"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/assets/img/service/05.jpg" alt="Businex-Blog" /></a>
                                      </figure>
                                  </div>
                              </div>
                              ...
                              <div class="col-md-6 col-lg-4">
                                  <div class="blog-item">
                                      <figure class="blog-thumb">
                                          <a href="blog-details.html"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/assets/img/service/06.jpg" alt="Businex-Blog" /></a>
                                      </figure>
                                  </div>
                              </div>
                          </div>
