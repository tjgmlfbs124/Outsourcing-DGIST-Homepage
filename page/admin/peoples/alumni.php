...
<div id="professorWrap" >
  ...
  <div class="header">
    ...
    <div class="edit">
      <button class="btn btn-outline-secondary" id="btn_profssor_add" onclick="edit('upload')">졸업생 추가</button>
      <button class="btn btn-outline-secondary" id="btn_profssor_edit" onclick="edit('update')" disabled="true">졸업생 편집</button>
      <button class="btn btn-outline-secondary" id="btn_profssor_delete" onclick="edit('delete')"disabled="true">졸업생 삭제</button>
    </div>
  </div>
